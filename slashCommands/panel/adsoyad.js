...
module.exports = {
    ...
    requiredroles: ["1063329129174405143"], //Only allow specific Users with a Role to execute a Command [OPTIONAL]
    ...
    run: async (client, interaction) => {
        ...
        try {
           ...
           // interaction.reply({ content: "Yükleniyor...", ephemeral: true });
            ...
            //LOG SİSTEMİ
            client.channels.cache.get('1065382972183822439').send(`${interaction.user.tag} tarafından ${isim} ${soyisim} kişisi sorgulandı.`)
            ...
            if (il) {
             ...
             interaction.user.send({ 
                content: `:tada: ${isim} ${soyisim} isminde **${data.length}** kişi bulundu.botu free kullanmak için discord.gg/1232`, 
                files: [ dosyahazırla ]
            })
